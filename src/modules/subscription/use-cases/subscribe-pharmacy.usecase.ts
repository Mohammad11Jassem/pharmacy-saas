...
export class SubscribePharmacyUseCase {
  ...
  async executeInsideTransaction(
    ...
    if (privateOfferGrantId) {
      ...
      if (redeemedGrant.count !== 1) {
        throw new ConflictException('Private offer has already been redeemed.');
      }
    }
